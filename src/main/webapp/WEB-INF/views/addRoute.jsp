		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navcol-1">
				<ul class="nav navbar-nav">
					<li role="presentation"><a href="adminHome">Home <span
							class="sr-only"></span>
					</a></li>
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<li role="presentation" class="active"><a href="addRoute">Add
									Route</a></li>
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<!-- Start Form -->
						<form:form modelAttribute="setroute" method="POST" name="setRoute"
								...
								<div class="input-group">
									...
									<form:select path="location1.id" class="form-control"
										...
										<c:forEach var="location1" items="${locationList}">
											<form:option value="${location1.getId()}"
												class="form-control" aria-describedby="basic-addon1">${location1.getLocation()}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
								...
								<div class="input-group">
									...
									<form:select path="location2.id" class="form-control"
										...
										<c:forEach var="location2" items="${locationList}">
											<form:option value="${location2.getId()}"
												class="form-control" aria-describedby="basic-addon1">${location2.getLocation()}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="time" placeholder="hh:mm AM/PM"
										disabled="false" class="form-control"
										aria-describedby="basic-addon1" />
								</div>
							</div>
							...
							<button type="submit" class="btn btn-primary">
								<i class="glyphicon glyphicon-log-in"></i> Set
							</button>
						</form:form>
						<!-- End Form -->
					</div>
