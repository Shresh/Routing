...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/setRoute_validation.js"></script>
<script type="text/javascript"
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<!-- Start Form -->
						<form:form method="POST" modelAttribute="setRoute"
							action="${pageContext.request.contextPath}/updateRoute" name="setRoute" onsubmit="return validate();">
							<div class="form-group">
								<label for="bus.id">Bus No</label>
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1"><i
										class="glyphicon glyphicon-tag"></i></span>
									<form:select path="bus.id" class="form-control"
										aria-describedby="basic-addon1">
										<c:forEach var="bus" items="${bsList}">
											<form:option value="${bus.getId()}" class="form-control"
												aria-describedby="basic-addon1">${bus.getBusNo()}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="form-group">
								<label for="location1.id">From</label>
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1"><i
										class="glyphicon glyphicon-map-marker"></i></span>
									<form:select path="location1.id" class="form-control"
										aria-describedby="basic-addon1">
										<c:forEach var="location1" items="${locationList}">
											<form:option value="${location1.getId()}" class="form-control"
												aria-describedby="basic-addon1">${location1.getLocation()}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="form-group">
								<label for="location2.id">To</label>
								<div class="input-group">
									<span class="input-group-addon" id="basic-addon1"><i
										class="glyphicon glyphicon-map-marker"></i></span>
									<form:select path="location2.id" class="form-control"
										aria-describedby="basic-addon1">
										<c:forEach var="location2" items="${locationList}">
											<form:option value="${location2.getId()}" class="form-control"
												aria-describedby="basic-addon1">${location2.getLocation()}</form:option>
										</c:forEach>
									</form:select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="date" placeholder="mm/dd/yyyy" disabled="false" class="form-control"
										aria-describedby="basic-addon1" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<form:input path="time" placeholder="hh:mm AM/PM" disabled="false" class="form-control"
										aria-describedby="basic-addon1" />
								</div>
							</div>
