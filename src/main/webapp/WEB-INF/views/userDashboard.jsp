	...
	<nav class="navbar navbar-fixed-top navbar-inverse"
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userhome">Routing</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="userhome">Home <span
							class="sr-only">(current)</span></a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false">Profile<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="userVProfile">View Profile</a></li>
							<li><a href="userEProfile">Edit Profile</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false">Route<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="userViewAvailableRoute">View Route</a></li>
						</ul></li>
				</ul>
